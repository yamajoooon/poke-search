...
return (    
    <div>
    <Button variant="outlined" className="mr-2" onClick={openModal}>モーダル表示</Button>
    <Modal
        isOpen={modalIsOpen}
    ...
    >
        ...
        <div className= {classes.buttonPosition}>
            <Button variant="outlined" className={classes.button}>編集に戻る</Button>
            <Button variant="contained" color="primary" className={classes.button} onClick={closeModal}>保存する</Button>
        </div>
    </Modal>
    </div>
);
